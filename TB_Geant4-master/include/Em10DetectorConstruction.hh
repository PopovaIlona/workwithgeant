...
private:
  ...
  // TR radiator, windows volumes and dimensions
...
//  G4VPhysicalVolume* fPhysicRadRing;   // pointer to the physical R-slide
  ...
  G4Box*             fsolidWinR;
  G4LogicalVolume*   flogicWinR;
  G4VPhysicalVolume* fphysWinR;
  
  G4Box*             fsolidBox1;
  G4LogicalVolume*   flogicBox1;
  G4VPhysicalVolume* fphysBox1;

  G4Box*             fsolidBox;
  G4LogicalVolume*   flogicBox;
  G4VPhysicalVolume* fphysBox;

  G4Box*             fsolidPixel;
  G4LogicalVolume*   flogicPixel;
  G4VPhysicalVolume* fphysPixel;

  G4Box*             fsolidWin;
  G4LogicalVolume*   flogicWin;
  G4VPhysicalVolume* fphysWin;
